...
const EXT2_FEATURE_RO_COMPAT_SUPP: u32 =
    EXT2_FEATURE_RO_COMPAT_SPARSE_SUPER | EXT2_FEATURE_RO_COMPAT_LARGE_FILE | EXT2_FEATURE_RO_COMPAT_BTREE_DIR;
...
const EXT3_FEATURE_RO_COMPAT_SUPP: u32 =
    EXT2_FEATURE_RO_COMPAT_SPARSE_SUPER | EXT2_FEATURE_RO_COMPAT_LARGE_FILE | EXT2_FEATURE_RO_COMPAT_BTREE_DIR;
...
impl SuperBlock for ExtSuperBlock {
    ...
    fn validate_superblock(&self) -> bool {
        ...
        if (self.extended.feature_ro_compat & EXT2_FEATURE_RO_COMPAT_UNSUPPORTED != 0)
            || (self.extended.feature_incompat & EXT2_FEATURE_INCOMPAT_UNSUPPORTED != 0)
        {
            return false;
        }
...
impl SuperBlock for Ext3SuperBlock {
    ...
    fn validate_superblock(&self) -> bool {
        ...
        if (self.block.extended.feature_ro_compat & EXT3_FEATURE_RO_COMPAT_UNSUPPORTED != 0)
            || (self.block.extended.feature_incompat & EXT3_FEATURE_INCOMPAT_UNSUPPORTED != 0)
        {
            return false;
        }
