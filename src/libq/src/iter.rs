pub trait SplitOn where Self: Iterator, Self: Sized, Self::Item: PartialEq {
...
impl<I: Iterator + Sized> SplitOn for I where I::Item: PartialEq {
    fn split_on(self, val: Self::Item, inclusive: bool) -> SplitOnIter<Self> {
        return SplitOnIter::new(self, val, inclusive);
    }
}

pub struct SplitOnIter<I> where I: Iterator, I::Item: PartialEq {
    iter: I,
    val: I::Item,
    inclusive: bool
}

impl<I: Iterator> SplitOnIter<I> where I::Item: PartialEq {
...
impl<I: Iterator> Iterator for SplitOnIter<I> where I::Item: PartialEq {
